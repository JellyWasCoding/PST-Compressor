namespace PST {
    ...
    public static class Tables {
        ...
        ADD PIECE-SQUARE TABLES HERE
    
        */

        public static readonly sbyte[,] pawnScores = 
        {
            { 0,  0,  0,  0},
            {10, 10, 20, 30},
            {50, 50, 50, 50},
        ...
        public static readonly sbyte[,] knightScores =
        {
            {-50,-40,-30,-30},
            {-40,-20,  0,  0},
            {-30,  0, 10, 15},
        ...
        public static readonly sbyte[,] bishopScores =
        {
            {-20,-10,-10,-10},
            {-10,  0,  0,  0},
            {-10,  0,  5, 10},
        ...
        public static readonly sbyte[,] rookScores =
        {
            { 0,  0,  0,  0},
            { 5, 10, 10, 10},
            {-5,  0,  0,  0},
        ...
        public static readonly sbyte[,] queenScores =
        {
            {-20,-10,-10, -5},
            {-10,  0,  0,  0},
            {-10,  0,  5,  5},
        ...
        public static readonly sbyte[,] kingScores =
        {
            {-30,-40,-40,-50},
            {-30,-40,-40,-50},
            {-30,-40,-40,-50},
        ...
        public static readonly sbyte[,] MiddleKingScores =
        {
            {-30,-40,-40,-50},
            {-30,-40,-40,-50},
            {-30,-40,-40,-50},
        ...
        public static readonly sbyte[,] EndKingScores =
        {
            {-50,-40,-30,-20},
            {-30,-20,-10,  0},
            {-30,-10, 20, 30},
    ...
    public static class PieceTables {
        public static void Pack(bool styling = false)
        {
            ...
            List<sbyte[,]> allScores = new()
            {
                ...
                Tables.queenScores,
                Tables.kingScores,
                Tables.MiddleKingScores,
                Tables.EndKingScores
            };
